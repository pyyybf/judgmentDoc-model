...
def train_model(model, args, train_data, valid_data, test_data, article_dict):
    ...
    pos_dataset = MyDataset(train_pos, args.fact_len, args.article_len, article_dict, tokenizer)
    neg_dataset = MyDataset(train_neg, args.fact_len, args.article_len, article_dict, tokenizer)
    valid_dataset = MyDataset(valid_pos + valid_neg, args.fact_len, args.article_len, article_dict, tokenizer)

    pos_batch_size = math.ceil(args.batch_size / (args.negative_multiple + 1))
    ...
    test_dataset = MyDataset(test_pos + test_neg, args.fact_len, args.article_len, article_dict, tokenizer)
